...
class ArkOfficialInfoPlatformAdapter :
RecyclerView.Adapter<ArkOfficialInfoPlatformAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_ark_official_info_platform, parent, false)
        )
    }
